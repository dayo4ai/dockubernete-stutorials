...
import { ArrowRight, Sparkles, AlertTriangle, Wifi, WifiOff } from "lucide-react"
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {apiStatus !== "checking" && (
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-4">
          <Alert
            className={apiStatus === "offline" ? "border-orange-200 bg-orange-50" : "border-green-200 bg-green-50"}
          >
            <div className="flex items-center gap-2">
              ...
              <AlertDescription className={apiStatus === "online" ? "text-green-800" : "text-orange-800"}>
                {apiStatus === "online"
                  ? "Connected to live API - Real-time data"
                  : "API offline - Using demo data for preview"}
              </AlertDescription>
            </div>
          </Alert>
        </motion.div>
